            ...
            {filters.map((filter, idx) => (
              <button
                ...
                className={`px-6 py-3 rounded-full font-medium transition-all ${
                  activeFilter === filter
                    ? "bg-[#E82600] text-white shadow-lg"
              ...
              >
                <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <span className="inline-block bg-blue-100 text-[#E82600] px-3 py-1 rounded-full text-xs font-medium mb-2">
                        {job.department}
                      </span>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <NavLink to='/career-detail'>
                      <button className="bg-[#E82600] cursor-pointer text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-800 transition-all">
                        Apply Now
                      </button>
                    </NavLink>
                  </div>
