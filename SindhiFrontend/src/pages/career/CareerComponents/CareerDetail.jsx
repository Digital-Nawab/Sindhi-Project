...
const techStack = [
  ...
  {
    category: "Monitoring",
    tools: ["New Relic", "DataDog", "Sentry", "CloudWatch"],
  },
];
...
const benefits = [
  {
    ...
    desc: "₹15-22 LPA + performance bonus + ESOP",
  },
  {
    icon: "🏥",
    title: "Health Coverage",
    desc: "Complete medical insurance for you and family",
  },
  {
    icon: "📚",
    title: "Learning Budget",
    desc: "₹75,000 annual budget for courses, conferences, books",
  },
  {
    icon: "🏠",
    title: "Flexible Work",
    desc: "Hybrid model with 2 days WFH + co-working allowance",
  },
  {
    icon: "🚀",
    title: "Career Growth",
    desc: "Fast-track promotion opportunities + internal mobility",
  },
  {
    icon: "🎉",
    title: "Team Culture",
    desc: "Quarterly offsites + hackathons + team bonding activities",
  },
];
...
const hiringProcess = [
  {
    ...
    desc: "Resume screening and initial assessment",
    duration: "2-3 days",
  },
  {
    step: 2,
    title: "Technical Assessment",
    desc: "Coding challenge or take-home assignment",
    duration: "3-4 days",
  },
  {
    step: 3,
    title: "Technical Interview",
    desc: "System design and problem-solving discussion",
    duration: "1 hour",
  },
  {
    step: 4,
    title: "Team Interaction",
    desc: "Meet your potential team members and manager",
    duration: "45 mins",
  },
  {
    step: 5,
    title: "Final Discussion",
    desc: "Culture fit and offer discussion with leadership",
    duration: "30 mins",
  },
];
...
const teamMembers = [
  {
    ...
    image: "👩‍💼",
    desc: "10+ years at Google, Meta. Leads platform architecture.",
  },
  {
    name: "Rahul Kumar",
    role: "Senior Backend Engineer",
    image: "👨‍💻",
    desc: "Ex-Flipkart. Expert in microservices and scalability.",
  },
  {
    name: "Sneha Patel",
    role: "Frontend Lead",
    image: "👩‍💻",
    desc: "Design systems expert. Loves building delightful UX.",
  },
  {
    name: "Amit Gupta",
    role: "DevOps Engineer",
    image: "👨‍🔧",
    desc: "Cloud infrastructure guru. Ensures 99.9% uptime.",
  },
];

const faqs = [
  {
    q: "What's the work culture like in the engineering team?",
    a: "We follow agile methodologies with 2-week sprints, daily standups, and retrospectives. The culture emphasizes ownership, continuous learning, and work-life balance. We have dedicated time for technical debt and innovation projects.",
  },
  {
    q: "What growth opportunities are available?",
    a: "Clear career progression from Senior to Staff to Principal Engineer. We also offer lateral moves to product management, technical writing, or team leadership. 70% of our engineering managers were promoted internally.",
  },
  {
    q: "How do you handle on-call and production support?",
    a: "We have a fair rotation system where each engineer does on-call once every 6-8 weeks. We provide on-call compensation and ensure proper documentation and monitoring to minimize incidents.",
  },
  {
    q: "What's the typical day-to-day work?",
    a: "Mix of feature development, code reviews, technical discussions, and collaboration with product/design teams. You'll spend 60% time coding, 20% in meetings, and 20% on planning and code reviews.",
  },
];
              ...
              <div className="lg:w-80">
                <div className="bg-gradient-to-br from-blue-900 to-indigo-900 text-white p-6 rounded-xl">
                  ...
                  <p className="text-blue-100 mb-6 text-sm">
                    Join 180+ talented individuals building India's future of
                    commerce.
                  </p>
                  <button
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl">
                    <h3 className="font-bold text-gray-900 mb-2">
                      💡 Not sure if you meet all requirements?
                    </h3>
                    <p className="text-gray-700 text-sm">
                      We encourage you to apply anyway! We value diverse
                      perspectives and are happy to train motivated candidates
                      who show potential.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  <div className="bg-white p-6 rounded-xl shadow-sm">
                    ...
                    <p className="text-gray-600 mb-6">
                      You'll be working closely with this amazing team of
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-sm">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="text-center p-4 bg-blue-50 rounded-lg">
                        ...
                        <p className="text-gray-600 text-sm">
                          We encourage experimentation and learning from
                          failures
                        </p>
                      </div>
                      ...
                      <div className="text-center p-4 bg-purple-50 rounded-lg">
                        ...
                        <p className="text-gray-600 text-sm">
                          Focus on features that move business metrics
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {activeTab === "process" && (
                <div className="space-y-8">
                  <div className="bg-white p-6 rounded-xl shadow-sm">
                    ...
                    <p className="text-gray-600 mb-6">
                      We've designed our process to be efficient and
                      transparent. The entire process typically takes 1-2 weeks.
                    </p>
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-xl">
                    ...
                    <ul className="text-gray-700 text-sm space-y-1">
                      <li>
                        • Review system design concepts (scalability, databases,
                        caching)
                      </li>
                      <li>
                      ...
                      <li>
                        • Be ready to discuss your past projects and technical
                        decisions
                      </li>
                      <li>
                        • Prepare questions about our tech stack and engineering
                        culture
                      </li>
                    </ul>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 p-6 rounded-xl">
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      We're happy to answer any questions about this role or
        ...
        {showApplicationModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl max-w-md w-full p-6">
              ...
              <p className="text-gray-600 mb-6">
                We'll redirect you to our application portal where you can
                upload your resume and complete the application.
              </p>
