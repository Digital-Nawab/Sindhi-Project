      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
            ...
            or just want to say hello – drop us a message or find us at our
            office.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="relative bg-[#053951] shadow-md rounded-xl p-6 hover:shadow-lg transition flex flex-col text-white">
            ...
            <div className="mt-6">
              ...
              <p className="text-sm">Service: info@sewconnect.in</p>
            </div>
          </div>
