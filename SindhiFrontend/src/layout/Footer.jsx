      ...
      <div className="row">
        <div className="col-lg-3 width-25 mb-30">
          ...
          <div className="font-md mb-20 color-gray-900">
            <strong className="font-md-bold">Address:</strong> 502 New Design
            Str, Melbourne, San Francisco, CA 94110, United States
          </div>
          <div className="font-md mb-20 color-gray-900">
          ...
          <div>
            ...
            <div className="mt-20">
              <a className="mr-10" href="#">
                <img src="assets/imgs/template/appstore.png" alt="Ecom" />
              </a>
              <a href="#">
                <img src="assets/imgs/template/google-play.png" alt="Ecom" />
              </a>
            </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12 text-center text-lg-end">
            <ul className="menu-bottom">
              ...
              <li>
                <a className="font-sm color-gray-900" href="page-careers.html">
                  Interest-Based Ads
                </a>
              </li>
            </ul>
